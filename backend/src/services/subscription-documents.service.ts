...
async function buildContract(request: RenewalRequest): Promise<Buffer> {
  ...
  paragraph(
    doc,
    "3.1. Общая цена Договора составляет 10 000 (десять тысяч) рублей 00 копеек. 3.2. Стоимость включает все издержки и налоговые обязательства Исполнителя. 3.3. Цена Договора является твёрдой и не подлежит изменению в течение срока его действия. 3.4. Оплата производится Заказчиком в форме безналичного расчёта на основании счёта, выставленного Исполнителем.",
  );
  ...
  paragraph(
    doc,
    "6.1. Договор составлен на русском языке в двух экземплярах, имеющих одинаковую юридическую силу, по одному для каждой Стороны. 6.2. Ни одна из Сторон не вправе передать полностью или частично свои права и обязанности без предварительного письменного согласия другой Стороны.",
  );
  paragraph(
    doc,
  ...
  paragraph(
    doc,
    "3. Настоящий Акт составлен в двух экземплярах, имеющих одинаковую юридическую силу, по одному экземпляру для каждой Стороны. 4. Претензий по исполнению Договора Стороны друг к другу не имеют.",
  );
  doc.moveDown(2);
  doc
    .font("Regular")
