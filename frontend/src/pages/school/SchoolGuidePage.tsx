...
const STEPS = [
  ...
  },
  {
    ...
    text: "Откройте профиль учителя в проекте, нажмите «Оценить» и выберите карту: методические компетенции или комплексную оценку. Заполните критерии. Для внешней оценки сразу укажите ФИО, должность и место работы. При внутришкольной оценке эти поля нужны только если оставляете комментарий.",
