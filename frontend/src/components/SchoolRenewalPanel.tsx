...
> = {
  pending: {
    title: "Заявка ожидает подтверждения",
        text: "Для оплаты используйте QR-код или реквизиты ниже. Если перевод уже отправлен, дождитесь подтверждения администратором. Договор и счёт появятся после проверки платежа.",
  },
  documents_ready: {
    title: "Заявка ожидает подтверждения",
    text: "Используйте QR-код или реквизиты ниже. Документы появятся после подтверждения оплаты администратором.",
  },
  paid: {
      ...
      {canEdit ? (
        <form className="school-renewal__form" onSubmit={submit}>
          ...
          <div className="school-renewal__actions">
            ...
            <p>
              Финальные номера присваиваются только после подтверждения оплаты:
              префикс документа, год, месяц и общий порядковый номер.
            </p>
          </div>
        </form>
      ) : null}
